...
const routes: Routes = [
  ...
  { path: 'gerenciar-carros/:carroId', component: GerenciaCarrosComponent, data: { title: 'Gerenciar Carros' } },
  { path: 'gerenciar-pecas/:pecaId', component: GerenciaPecasComponent, data: { title: 'Gerenciar Peças' } },
